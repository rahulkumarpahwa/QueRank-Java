    ...
    <div class="max-w-3xl mx-auto py-8">
      ...
      <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="p-8 border-b border-gray-200">
          <div class="text-center">
            ...
            <p class="text-indigo-600 mt-2">
              Company:
              <strong><%= request.getAttribute("companyName") %></strong>
            </p>
            <% } %>
          </div>
        </div>
        ...
        <div class="p-8">
          ...
          String message = ""; String colorClass = ""; if (rank != null) {
          switch(rank) { case 1: message = "Outstanding! You're in the top
          tier!"; colorClass = "bg-green-100 border-green-400 text-green-800";
          break; case 2: message = "Excellent work! Keep it up!"; colorClass =
          "bg-blue-100 border-blue-400 text-blue-800"; break; case 3: message =
          "Good job! There's room for improvement."; colorClass = "bg-yellow-100
          border-yellow-400 text-yellow-800"; break; case 4: message = "Fair
          attempt. Practice more to improve."; colorClass = "bg-orange-100
          border-orange-400 text-orange-800"; break; default: message = "Keep
          practicing! You can do better."; colorClass = "bg-red-100
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a
              href="<%= request.getContextPath() %>/company-select"
              class="block bg-indigo-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-indigo-700 transition text-center"
            >
              Take Another Quiz
            </a>
            <a
              href="<%= request.getContextPath() %>/all-results"
              class="block bg-purple-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-purple-700 transition text-center"
            >
              View All Results
            </a>
            <a
      ...
      <div class="mt-6 bg-white rounded-lg p-6 shadow-lg">
        ...
        <ul class="text-sm text-gray-600 space-y-2">
          <li>
            ✓ Review questions ranked higher - they're asked more frequently
          </li>
          <li>✓ Practice with different companies to broaden your knowledge</li>
